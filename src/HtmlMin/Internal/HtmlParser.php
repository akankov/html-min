...
final class HtmlParser
{
    ...
    /**
     * Common prefix for every placeholder value generated by the
     * preprocessing pass. Use {@see isPlaceholder()} from outside this class
     * — the prefix itself is internal so it can move without rippling.
     */
     ...
     * prefix (e.g. an attribute name like `____HTMLMIN_AT____change` that
     * was a Vue.js `@change` before the libxml round-trip). Callers in
     * HtmlMin use this to skip transformations that would corrupt the
     * placeholder, e.g. unquoted-attribute-value compaction.
     */
    public static function isPlaceholder(string $candidate): bool
    {
        return str_starts_with($candidate, self::PLACEHOLDER_PREFIX);
    }
     ...
     * names (e.g. "@change" → "____HTMLMIN_AT____change") come
